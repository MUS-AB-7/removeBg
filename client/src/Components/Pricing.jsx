        ...
        <div className='py-10 md:px-20 lg:px-20'>
            <div className='container mx-auto px-4'>
                ...
                <div className='mb-12 text-center'>
                    ...
                    <p>
                        Select from our carefully curated photography packages designed to meet you specific needs.
                    </p>
                </div>
                {/* Section table */}
                        ...
                        plans.map((plan) => (
                            <div key={plan.id} className={`relative pt-6 p-6 ${plan.popular ? 'backdrop-blur-lg rounded-2xl' : 'border-gray-800 rounded-xl'} bg-[#1A1A1A] hover:transform hover:-translate-y-2 transition-all duration-300`}>
                                ...
                                <div className='px-4 pb-8'>
                                    ...
                                    <button className='w-full py-3 px-6 text-center text-white font-semibold rounded-full bg-gradient-to-r from-purple-500 to-indigo-500 shadow-lg hover:from-purple-600 hover:to-indigo-600 transition duration-300 ease-in-out transform hover:scale-105 cursor-pointer' onClick={() => handleOrder(plan.id)}>
                                        Choose plan
                                    </button>
                                </div>
                            </div>
