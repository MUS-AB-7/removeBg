        ...
        <div className='grid grid-cols-1 md:grid-cols-2 gap-12 items-center mb-16'>
            ...
            <div className='order-1 md:order-1'>
                <h1 className='text-4xl md:text-5xl font-bold text-gray-900 mb-6 leading-tight'>
                    The fatest <span className='text-indigo-700'>background eraser.</span>
                </h1>
                <p className='text-gray-600 mb-8 test-lg leading-relaxed'>
                    Transform you photos with our background remover app! Hightlight your subject and create a transparent background, so you can place it in a variety of new designs and destinations. Try it now and immerse your subject in a completely different environment!
                </p>
                <div>
